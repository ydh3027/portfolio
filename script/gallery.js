...
$(function(){
      ...
      const pro_btn = $('.g_gnb > ul > li:nth-child(2) a');
      const proce_btn = $('.g_gnb > ul > li:nth-child(3) a');
      const de_btn = $('.g_gnb > ul > li:nth-child(4) > a');
      const co_btn = $('.g_gnb > ul > li:last-child > a');
      ...
      $('.g_list > li').click(function(e){
        ...
        //
        let i_num = $(this).index()+1;//1,2,3,4,5,6...
        console.log(i_num);
